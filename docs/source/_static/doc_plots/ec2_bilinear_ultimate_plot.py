...
def ec2_bilinear_ultimate_plot(render=False):
    """Creates a plot for use in the docstring of EurocodeBilinearUltimate class,
    ...
    """
    # create EurocodeBilinearUltimate stress-strain profile
    ...
    stress_strain_profile = ssp.EurocodeBilinearUltimate(
        compressive_strength=f_ck,
        alpha_cc=alpha_cc,
        gamma_c=gamma_c,
    )

    stress_strain_profile_nominal = ssp.EurocodeBilinearUltimate(
        compressive_strength=f_ck,
        alpha_cc=1,
        gamma_c=1,
    )
    ...
    eps_c3, eps_cu3 = stress_strain_profile.epsilon_bilinear(f_ck=f_ck)
    x = [
        0,
        eps_c3,
        eps_cu3,
    ...
    # add line to maximum strength f_cd at eps_c3
    plt.plot(
        [xmin, eps_c3, eps_c3],
        [f_cd, f_cd, ymin],
        "k",
    ...
    # add line to maximum strength f_ck at eps_c3
    plt.plot(
        [xmin, eps_c3, eps_c3],
        [f_ck, f_ck, f_cd],
        "k",
    ...
    # add line to maximum strength f_cd at eps_cu3
    plt.plot(
        [xmin, eps_cu3, eps_cu3],
        [f_cd, f_cd, ymin],
        "k",
        linewidth=0.75,
        dashes=[6, 6],
